...
### 01. 💡프로젝트 소개
* 수도권 교통 상황 분석  
* 기후동행카드 제도의 유효성을 입증하고 서울 외 수도권 확대 필요성 및 지역 제시
### 기후동행카드란?
...
-	selenium, beautifulsoup, trafilatura를 활용한 웹크롤링
...
|김세현|데이터 수집, 전처리 및 시각화 / DB, Readme 제작|
|김요한|데이터 수집, 전처리 및 시각화 / 분석(EDA)|
|신재훈|데이터 수집, 전처리 및 시각화 / 분석(EDA) / 발표|

# 프로젝트 과정
1. 대중교통 정보 사이트 등에서 데이터를 크롤링
2. 모은 데이터들을 데이터베이스에 모으고 종합 후 분석
...
2. 이외에도 서울시 열린데이터광장, 경기도교통정보센터, 서울교통정보 등 사이트들에서 데이터 수집
...
* 서울은 도시철도 이용량이 가장 많음
* 반면 경기도와 인천은 시내버스 이용량 가장 많음

### 수도권 오전 오후 유입인구
<img src="https://github.com/addinedu-ros-5th/eda-repo-3/assets/55865857/122e68a0-cdb8-45f1-9bb1-6c2f59e0aa0c" width="500">  

* 수도권 지역의 오전 오후별로 유입되는 인구 분포
* 경기도, 인천에선 인구가 오전에 유출되고 오후에 다시 유입되는 모습을 보이지만 서울에서는 인구가 오전에 유입되고 오후에 유출되는 양상
...
* 서울과의 통행이 많은 지역들, 서울과 버스와 철도가 잘 연결되어 있지만 기후동행카드의 혜택을 받지 못하는 지역들이 많음
